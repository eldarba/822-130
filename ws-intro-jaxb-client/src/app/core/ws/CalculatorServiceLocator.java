...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements app.core.ws.CalculatorService {
    ...
    public app.core.ws.Calculator getCalculatorPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            app.core.ws.CalculatorPortBindingStub _stub = new app.core.ws.CalculatorPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (app.core.ws.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                app.core.ws.CalculatorPortBindingStub _stub = new app.core.ws.CalculatorPortBindingStub(new java.net.URL(CalculatorPort_address), this);
                _stub.setPortName(getCalculatorPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.core.app/", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.core.app/", "CalculatorPort"));
        }
